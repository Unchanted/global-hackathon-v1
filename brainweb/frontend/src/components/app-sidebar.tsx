  ...
  return (
    <Sidebar>
            ...
            <SidebarMenuButton size="lg" asChild>
              <div className="flex items-center gap-2 px-2 py-1.5">
                ...
                <div className="grid flex-1 text-left text-sm leading-tight">
                  <span className="truncate font-semibold">Memory Keeper</span>
                  <span className="truncate text-xs">Family memories</span>
                </div>
              </div>
            </SidebarMenuButton>
          </SidebarMenuItem>
      ...
      <SidebarContent>
        ...
        {/* Grandparents Filter */}
        <SidebarGroup>
          <SidebarGroupLabel>Grandparents</SidebarGroupLabel>
          <SidebarGroupContent>
            <SidebarMenu>
              <SidebarMenuItem>
                <SidebarMenuButton 
        ...
        {/* Memory Types Filter */}
        <SidebarGroup>
          <SidebarGroupLabel>Memory Types</SidebarGroupLabel>
          <SidebarGroupContent>
            <SidebarMenu>
            ...
            <SidebarMenuButton size="lg" asChild>
              <div className="flex items-center gap-2 px-2 py-1.5">
                ...
                <div className="grid flex-1 text-left text-sm leading-tight">
                  ...
                  <span className="truncate text-xs">App preferences</span>
                </div>
              </div>
            </SidebarMenuButton>
          </SidebarMenuItem>
